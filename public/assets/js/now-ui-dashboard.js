...
var firebaseheading = firebase.database().ref().child("Users").child("user_01").child("Address").child("some");
    heading1.innerText(firebaseheading.val());

var rootRef = firebase.database().ref().child("Fines").child("Rhoé Administration").child("2018-03-14T22:34:52:045+0200");

rootRef.on("child_added", snap => {

  var licenseplate = snap.child("CarPlate").val();
  var fineamount = snap.child("FineAmount").val();

  $("#table_body").append("<tr><td>" + licenseplate +
      "</td><td>" + fineamount + "</td></tr>");
});
